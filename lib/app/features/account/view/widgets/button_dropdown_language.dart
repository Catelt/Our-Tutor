...
class ButtonDropDownLanguage extends StatefulWidget {
  ...
  final List<MLanguage>? selected;
  final void Function(List<MLanguage>)? onChange;

  @override
  State<ButtonDropDownLanguage> createState() => _ButtonDropDownLanguageState();
}

class _ButtonDropDownLanguageState extends State<ButtonDropDownLanguage> {
  final List<MLanguage> items = MLanguage.getData();

  List<MLanguage> selectedItems = [];
