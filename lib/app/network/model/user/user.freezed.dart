...
class _$MUserCopyWithImpl<$Res, $Val extends MUser>
  ...
  $MWalletInfoCopyWith<$Res>? get walletInfo {
    ...
    return $MWalletInfoCopyWith<$Res>(_value.walletInfo!, (value) {
...
class _$_MUser with DiagnosticableTreeMixin implements _MUser {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'MUser'))
      ...
      ..add(DiagnosticsProperty('walletInfo', walletInfo))
      ..add(DiagnosticsProperty('courses', courses))
      ..add(DiagnosticsProperty('requireNote', requireNote))
      ..add(DiagnosticsProperty('level', level))
      ..add(DiagnosticsProperty('learnTopics', learnTopics))
      ..add(DiagnosticsProperty('testPreparations', testPreparations))
      ..add(DiagnosticsProperty('isPhoneActivated', isPhoneActivated))
      ..add(DiagnosticsProperty('timezone', timezone))
      ..add(DiagnosticsProperty('studySchedule', studySchedule))
      ..add(DiagnosticsProperty('canSendMessage', canSendMessage))
      ...
      ..add(DiagnosticsProperty('tutorInfo', tutorInfo));
  }
