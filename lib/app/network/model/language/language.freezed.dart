...
mixin _$MLanguage {
  ...
  set nativeName(String value) => throw _privateConstructorUsedError;
...
class _$_MLanguage extends _MLanguage {
  ...
  @override
  String toString() {
    return 'MLanguage(code: $code, name: $name, nativeName: $nativeName)';
  }
...
abstract class _MLanguage extends MLanguage {
  factory _MLanguage(
      ...
      required String nativeName}) = _$_MLanguage;
